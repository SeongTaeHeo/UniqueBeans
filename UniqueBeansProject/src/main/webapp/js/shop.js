...
/*
 * $("#add_complpro").click( function() { console.log("주문 완료");
 * $("#complpro_table").append( "<tr>" + "<td>" + $("#tsel_name").text() + "</td>" + "<td>" +
 * $("#tsel_price").text() + "</td>" + "</tr>"); });
 */
$("#add_complpro").click(
function() {
	console.log("주문 완료");
