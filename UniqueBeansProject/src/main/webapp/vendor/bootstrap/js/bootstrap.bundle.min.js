...
var bootstrap = function(t, e) {
	...
	function f(t, e) {
		...
		o.setStart(i, 0), o.setEnd(r, 0);var s = o.commonAncestorContainer;
				...
				var t = "carousel",
					...
					h = function() {
						...
						return h.next = function() {
								...
								if (t === a.NEXT ? (i = c.LEFT, r = c.NEXT, o = a.LEFT) : (i = c.RIGHT, r = c.PREV, o = a.RIGHT), d && e(d).hasClass(c.ACTIVE))
									this._isSliding = !1;
			...
			modifiers : {
				...
				flip : {
					...
					fn : function(t, e) {
						...
						case gt.FLIP:
							s = [ i, r ];
							break;case gt.CLOCKWISE:
							s = K(i);
							break;case gt.COUNTERCLOCKWISE:
							s = K(i, !0);
							break;default:
							s = e.behavior
						}
